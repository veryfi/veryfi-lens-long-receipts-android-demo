...
## Veryfi Lens Android Examples <a name="example"></a>
You can find the demo project in this repository. You can also check the development documentation clicking on each one of them.
